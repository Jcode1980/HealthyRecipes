<?php
    ...
    class IngredientList extends ListViewWrapper   
    {
        ...
        { 
            parent::__construct($formData, "IngredientList");
        ...
        public function getDisplayGroup() 
        {
            if (! $this->displayGroup) 
            {
                ...
                $this->displayGroup = new PLDisplayGroup('Ingredient', $qual, $this->getSortBy($this->default_sort_key), $this->resPerPage(), $this, 'pageNo');
            }
        ...
        public function printField($header, $value, $id, $entity) 
        {
            // See if controller has method to print field
             ...
             {
                 case('options'):
                    addLinkWithParams("Edit", "IngredientEdit/$id", array());
                    break;
                 default:
                    if (is_numeric($value)) {
