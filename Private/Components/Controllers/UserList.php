<?php
    ...
    class UserList extends ListViewWrapper   
    {
        ...
        protected $default_sort_key = "given";
         
        public function __construct($formData) 
        { 
            parent::__construct($formData, "UserList");
        ...
        public function getDisplayGroup() 
        {
            if (! $this->displayGroup) 
            {
                ...
                $this->displayGroup = new PLDisplayGroup('User', $qual, $this->getSortBy($this->default_sort_key), $this->resPerPage(), $this, 'pageNo');
            }
        ...
        public function printField($header, $value, $id, $entity) 
        {
            // See if controller has method to print field
             ...
             {
                 case('options'):
                    addLinkWithParams("Edit", "UserEdit/$id", array());
                    break;
                 default:
                    if (is_numeric($value)) {
